...
<head>
    ...
    <title><?php echo $title->lecturercourse ;?></title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                รายวิชา (Course) ที่สอน ภาคการศึกษา 1/2562
                            </h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ชื่อรายวิชา (อังกฤษ)</th>
                                            <th class="text-center"># ลงทะเบียน</th>
                                            <th class="text-center"># ทวนสอบ</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <a href="show_result.php">Tiger Nixon</a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-pink">14</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <span class="badge bg-pink">0</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
