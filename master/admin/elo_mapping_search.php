<?php 
    ...
    //read only courses which don't map with ELOs
    $is_mapped = false;
...
<body class="theme-red">
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="elo_mapping.php"><i class="material-icons md-18">arrow_back</i>กลับ (Back)</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php while ($row = mysqli_fetch_array($result)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-xs bg-light-blue waves-effect" data-toggle="modal" data-target="#mapModal" data-id="<?php echo $row['course_id']; ?>" id="btn-map">
                                                    <i class="material-icons md-18">layers</i>
                                                    <span>Map ผลการเรียนรู้</span>
                                                </button>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <div class="modal fade" id="mapModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">เพิ่มผลการเรียนรู้สู่รายวิชา</h4>
                </div>
                <form role="form" method="POST" action="elo_mapping_op.php?action=i">
                    <div class="modal-body">
